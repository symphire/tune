...
use crate::domain::{ChatMessageInput, ChatMessageOk, ConversationId, HistoryMessage, MessageError, MessageOffset, MessageRecord, UserId};
...
pub trait ConversationStore {
    ...
    fn reconcile_fetch_request_state(&mut self, conversation_id: ConversationId, generation: Option<Generation>, value: AsyncValue<(), anyhow::Error>);
    fn reconcile_from_fetch(&mut self, trunk: Vec<MessageRecord>, is_fully_synced: bool) -> anyhow::Result<()>;
